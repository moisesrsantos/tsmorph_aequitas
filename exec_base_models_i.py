...
os.system('python base_models_main_i.py')


Extract_Performance(filename="NN5_i.csv", morphing=False, train=nn5).fit_transform()
performance = pd.read_csv("./data/performance/mase_nn5_i.csv", index_col="id")
